...
* Additional Investment in DEU - 2025
investments("DEU","2025") = investments("DEU","2025") + 12/5;
investments("DEU",rtime)  $(rtime.val > 2025)
                          = investments("DEU",rtime)  + 12/5 * 0.04/(1-(1-0.04)**(ttime1(rtime)-ttime1(rtime-1)));
